    ...
    <div class="careers-hero-inner">
        <div class="careers-hero-content">
            ...
            <div class="careers-hero-actions">
                <a href="{{ url('/contact') }}" class="careers-btn careers-btn-primary">Apply Now</a>
    ...
    <div class="careers-culture-inner">
        <div class="careers-culture-card">
            ...
            <div class="careers-culture-visual">
                <img src="{{ asset('images/scope.png') }}" alt="Work culture collaboration illustration" class="careers-culture-image">
            </div>
        </div>
    </div>
</section>
