...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/home.css') }}?v=daily-deposit-scheme-v1">
</head>
<body class="dds-page">
...
<main class="dds-main">
    <div class="dds-inner">
        <a href="{{ url('/#financial-offerings') }}" class="dds-back">
        ...
        <section class="dds-hero" aria-labelledby="dds-hero-heading">
            ...
            <div class="dds-hero-visual">
                <img src="{{ asset('images/money.jpg') }}" alt="Member with savings and daily deposit benefits" class="dds-hero-img" loading="eager" decoding="async" width="520" height="420">
            </div>
        </section>
        ...
        <section class="dds-terms" aria-labelledby="dds-terms-heading">
            ...
            <ol class="dds-terms-list">
                ...
                <li><strong>Contact Information:</strong> For any queries related to the Daily Deposit Scheme, members may contact our customer service at <a href="tel:+919640942443">+91 9640942443</a>, <a href="tel:+918142851404">+91 8142851404</a>, or <a href="mailto:jayalakshmicooperativebankltd@gmail.com">jayalakshmicooperativebankltd@gmail.com</a>.</li>
